package com.example.myapplicationasdf.ui.dashboard;
...
public class usersFragment extends Fragment implements View.OnClickListener,OnMapReadyCallback,ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public View mLayout;  // Snackbar 사용하기 위해서는 View가 필요합니다.
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mLayout = inflater.inflate(R.layout.fragment_users, container, false);
